    ...
    internal class Program
    {
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("'" + str1 + "'" + " contains " + SpaceCount_1(str1) + " spaces.");


            Console.Write("Input a string : ");  //task7 3rd way    
        ...
        static void CountNumberOfSpaces(string str)
        {
            ...
            Console.WriteLine("This string contains " + counter + " spaces.");
        }

        static int SpaceCount_1(string str)
        {
            int count = 0;
            string str1;
        ...
        static void SpaceCount_2(string str2)
        {
            int count = 0;
            ...
            Console.WriteLine("This string contains " + count + " spaces.");
        }
