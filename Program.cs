...
namespace task3
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Please, Write your date of birth: ");  //var myBirtday = new DateTime(2002, 11, 20);
        ...
        {
            Console.WriteLine("Please, Write your date of birth: ");  //DateTime myBirtday = new DateTime(2002, 11, 20, 0, 0, 0);
        ...
        static void Main4(string[] args) //task4
        {
            ...
            var strformatdate = formatdate.ToShortDateString();   /*DateTime nowdate = new DateTime.Now;
                                                                    strformatnowdate=nowdate.ToShortDateString();
                                                                    bool check = strformatdate == strformatnowdate;*/
        ...
        static void Main(string[] args) //task6        //VERY DIFFICULT
        {
            int day, month, year;
            Console.Write("Input the Day: ");
            day = int.Parse(Console.ReadLine());
            ...
            switch (dayofweek)
            {
                case DayOfWeek.Monday:
                    Console.WriteLine($"The last day of the week for the above date is: {(date.AddDays(6)).ToShortDateString()}");
                    break;
                case DayOfWeek.Tuesday:
                    Console.WriteLine($"The last day of the week for the above date is: {(date.AddDays(5)).ToShortDateString()}");
                    break;
                case DayOfWeek.Wednesday:
                    Console.WriteLine($"The last day of the week for the above date is: {(date.AddDays(4)).ToShortDateString()}");
                    break;
                case DayOfWeek.Thursday:
                    Console.WriteLine($"The last day of the week for the above date is: {(date.AddDays(3)).ToShortDateString()}");
                    break;
                case DayOfWeek.Friday:
                    Console.WriteLine($"The last day of the week for the above date is: {(date.AddDays(2)).ToShortDateString()}");
                    break;
                case DayOfWeek.Saturday:
                    Console.WriteLine($"The last day of the week for the above date is: {(date.AddDays(1)).ToShortDateString()}");
                    break;
                default:
